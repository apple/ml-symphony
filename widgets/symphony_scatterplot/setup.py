...
data_files_spec = [
    ('share/jupyter/nbextensions/symphony_scatterplot',
     'symphony_scatterplot/nbextension', '**'),
    ('share/jupyter/labextensions/symphony-scatterplot',
     'symphony_scatterplot/labextension', '**'),
    ('share/jupyter/labextensions/symphony-scatterplot',
     '.', 'install.json'),
    ('etc/jupyter/nbconfig/notebook.d', '.',
     'symphony_scatterplot.json'),
]
